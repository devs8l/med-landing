...
const Home = () => {
  ...
  return (
    <div className='w-full min-h-screen flex flex-col'>
      ...
      {/* part4 */}
      <div className='z-100 flex flex-col justify-between mt-10 md:mt-20 items-center w-full'>
        ...
        <div className='flex flex-col-reverse md:flex-row gap-5 justify-start items-center relative md:h-[50vh] mt-10 md:mt-20 w-full bg-[#2f85f7] rounded-3xl overflow-hidden'>
          <img src="/hero-main.png" className='absolute w-full h-full object-cover opacity-30' alt="" />
          <div className='flex flex-col gap-5 md:gap-10 z-100 justify-center items-center w-full md:w-1/2 p-6 md:p-0'>
          ...
          <div className='bg-[#ffffff50] w-full md:w-1/2 flex justify-center items-center py-6 md:py-0 md:h-full rounded-3xl'>
            <div className='h-full w-full md:w-2/3 md:h-[90%] overflow-hidden rounded-xl z-100 px-4 md:px-0'>
              <img className='w-full h-full object-cover' src="/col-1.png" alt="" />
            </div>
          </div>
        </div>

        <div className='flex flex-col md:flex-row-reverse items-center gap-5 relative md:h-[50vh] mt-10 md:mt-20 w-full bg-[#2f85f7] rounded-3xl overflow-hidden'>
          <img src="/hero-main.png" className='absolute w-full h-full object-cover opacity-30' alt="" style={{ objectPosition: '95% 100%' }} />
          <div className='flex flex-col gap-5 md:gap-10 z-100 justify-start items-center w-full md:w-1/2 p-6 md:p-0'>
            <div className='flex flex-col gap-3 md:gap-5 items-center md:items-start'>
          ...
          <div className='bg-[#ffffff50] w-full md:w-1/2 flex justify-center items-center py-6 md:py-0 md:h-full rounded-3xl'>
            <div className='w-full md:w-[90%] h-full md:h-[90%] overflow-hidden rounded-xl z-100 px-4 md:px-0'>
              <img src="/col-2.png" className='w-full h-full object-cover' alt="" />
            </div>
          </div>
        </div>

        <div className='flex flex-col-reverse md:flex-row gap-5 relative md:h-[50vh] items-center mt-10 md:mt-20 w-full bg-[#2f85f7] rounded-3xl overflow-hidden'>
          <img src="/hero-main.png" className='absolute w-full h-full object-cover opacity-30' alt="" />
          <div className='flex flex-col gap-5 md:gap-10 z-100 justify-center items-center w-full md:w-1/2 p-6 md:p-0'>
      ...
      <div className='flex gap-5 justify-center items-center relative h-[60vh] md:h-[50vh] mt-10 md:mt-20 w-full bg-[#2f85f7] rounded-3xl overflow-hidden py-10 md:py-0'>
        <img src="/hero-main.png" className='absolute w-full h-full object-cover opacity-30' alt="" />
        <div className='flex flex-col gap-5 md:gap-10 z-100 justify-center items-center px-4'>
